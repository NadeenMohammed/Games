                    ...
                    <div className="col-md-6 pt-4 ">
                        ...
                        <form className="row ">
                            ...
                            <div className="col-12">
                                ...
                                <input type="email" name='user_email' onChange={(e)=>getUserData(e)} className="form-control" id="inputEmail" placeholder="Email"/>
                            </div>
                            <div className="col-12">
                                <label for="inputAge" className="form-label"></label>
                                <input type="number" name='user_age' onChange={(e)=>getUserData(e)} className="form-control" id="inputAge" placeholder="Age  "/>
                            </div>
                            <div className="col-12">
                                <label for="inputpassword" className="form-label"></label>
                                <input type="password" name='user_password' onChange={(e)=>getUserData(e)} className="form-control" id="inputpassword" placeholder="New Password"/>
                            </div>
